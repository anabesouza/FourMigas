$(function () { // quando o documento estiver pronto/carregado
    ...
    $(document).on("click", "#btAtualizarPessoa", function () {
        ...
        var dados = JSON.stringify({ id: id, nome: nome, email: email, telefone: tel, estado: estado, cidade: cidade, cep: cep, rua: rua, numero: numero, complemento: complemento });
    ...
    function exibir_no_form(retorno) {
        if (retorno.resultado == "ok") {
            ...
            $("#campoEstado").val(pessoa.estado);
            $("#campoCidade").val(pessoa.cidade);
            $("#campoCep").val(pessoa.cep);
            $("#campoEndereco").val(pessoa.rua);
            $("#campoNumero").val(pessoa.numero);
            $("#campoComplemento").val(pessoa.complemento);
        } else {
